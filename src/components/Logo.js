const Logo = () => {
  return(
    <svg name="saatvaLogo" className="icon saatvaLogo" role="img" alt="Saatva Logo" description="Saatva Logo" viewBox="0 0 180 38.3" width="180" height="38.3" aria-labelledby="saatvaLogo">
